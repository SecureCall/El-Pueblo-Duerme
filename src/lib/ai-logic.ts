...
import type { Game, Player, NightAction, PlayerRole, AIPlayerPerspective } from "@/types";
import { generateAIChatMessage } from "@/ai/flows/generate-ai-chat-flow";
import { toPlainObject } from "./utils";
import { getSdks } from "@/firebase/server-init";
import { sendChatMessage, sendWolfChatMessage, sendTwinChatMessage, sendLoversChatMessage, submitNightAction, submitVote } from "./firebase-actions";
