...
import { sendFairyChatMessage } from '@/lib/firebase-client-actions';
    ...
    return (
        <Card className="bg-fuchsia-900/20 border-fuchsia-400/40 flex flex-col h-full max-h-80">
            <CardHeader className='pb-2'>
                <CardTitle className="font-headline text-fuchsia-300 text-lg flex items-center gap-2">
            ...
            <CardContent className="flex-1 overflow-hidden p-0">
                <ScrollArea className="h-full" ref={scrollAreaRef}>
                    <div className="p-4 space-y-3">
                        {messages.length === 0 ? (
                            <p className="text-center text-sm text-muted-foreground">Vuestro poder ha despertado. Coordinad vuestra maldición.</p>
                        ) : (
                            messages.map((msg, index) => {
                                ...
                                <div key={msg.id || index} className={cn(
                                    ...
                                    <div className={cn(
                                        ...
                                        isOwnMessage ? "bg-fuchsia-600 text-white" : "bg-card"
                                    )}>
            ...
            <CardFooter className="p-2 border-t border-fuchsia-400/30">
                <form 
                ...
                >
                    <Input
                        ...
                        placeholder="Habla con la otra hada..."
                        className="bg-card/50"
                    />
                    <Button type="submit" size="icon" variant="outline" className="bg-fuchsia-600 hover:bg-fuchsia-700" disabled={!newMessage.trim()}>
