...
import { signInWithGoogle } from '@/lib/firebase/auth-social';
  ...
  return (
    <div className="space-y-5">
      ...
      <p className="text-center text-white/30 text-xs pt-1">
        ¿Ya tienes cuenta?{' '}
        <a href="/login" className="text-white/60 hover:text-white underline underline-offset-2 transition-colors font-medium">
          Iniciar sesión
        </a>
      </p>
    </div>
