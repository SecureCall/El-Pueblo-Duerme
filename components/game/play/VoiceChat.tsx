        ...
        <div className="px-3 pb-3 space-y-2 border-t border-white/10">
          ...
          {canSpeak && permissionGranted && (
            <div className="flex items-center justify-between pt-2">
              ...
              <button
                onClick={toggleMute}
                className={`w-7 h-7 rounded-full flex items-center justify-center transition-all shadow ${isMuted ? 'bg-red-700 hover:bg-red-600' : 'bg-green-700 hover:bg-green-600'}`}
          ...
          {!canSpeak && permissionGranted && (
            <p className="text-white/40 text-[10px] pt-2 flex items-center gap-1"><span>👂</span> Solo escuchas</p>
          )}
