...
s = s.replace("import { BOT_VOTE_CONFIG, pickBotVoteTarget, type BotType, FALLBACK_BOT_MESSAGES, BOT_NARRATOR_SPOTLIGHTS } from '@/lib/bots/botSystem';", "import { type BotType, FALLBACK_BOT_MESSAGES, BOT_NARRATOR_SPOTLIGHTS } from '@/lib/bots/botSystem';", 1)
...
for token in [
    'async function processDayVotes',
    'Host processes day votes when all eligible alive players have voted',
    'Host auto-votes for AI players during day',
    'BOT_VOTE_CONFIG',
    'pickBotVoteTarget',
    'processDayVotes(',
    'dayResolutionLeaseRef',
    'processingDayRef',
    'aiDayVotedRound',
]:
