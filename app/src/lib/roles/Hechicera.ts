...
export class Hechicera implements IRole {
  ...
  performNightAction(context: GameContext, action: NightAction): GameStateChange | null {
    ...
    // La lógica de la Hechicera es reactiva y se aplica en el motor del juego (game-engine.ts).
    // Esta función solo marca la poción como usada.
  ...
  onDeath(context: GameContext, cause: import("@/types").GameEvent['type']): GameStateChange | null {
    return null;
  }
