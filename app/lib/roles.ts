...
const createImagePath = (key: string) => `/roles/${key.replace(/_/g, '-')}.png`;
...
export const roleDetails: Partial<Record<NonNullable<PlayerRole>, RoleDetail>> = {
    ...
    villager: {
        ...
        image: createImagePath("villager"),
        color: "text-white",
    ...
    guardian: {
        ...
        image: createImagePath("guardian"),
        color: "text-gray-300",
        bgImageId: "role-bg-doctor",
        team: "Aldeanos",
    },
    ...
    lycanthrope: {
        ...
        image: createImagePath("lycanthrope"),
    ...
    hechicera: {
        ...
        image: createImagePath("hechicera"),
    ...
    virginia_woolf: {
        ...
        image: createImagePath("virginia_woolf"),
        color: "text-rose-300",
        bgImageId: "role-bg-villager",
        team: "Aldeanos",
    },
    ...
    river_siren: {
        ...
        image: createImagePath("river_siren"),
        color: "text-cyan-400",
        bgImageId: "role-bg-seer",
        team: "Aldeanos",
    },
    ...
    troublemaker: {
        ...
        image: createImagePath("troublemaker"),
    ...
    silencer: {
        ...
        image: createImagePath("silencer"),
    ...
    seer_apprentice: {
        ...
        image: createImagePath("seer_apprentice"),
        color: "text-blue-300",
        bgImageId: "role-bg-seer",
        team: "Aldeanos",
    },
    elder_leader: {
        ...
        image: createImagePath("elder_leader"),
        color: "text-gray-500",
        bgImageId: "role-bg-villager",
        team: "Aldeanos",
    },
    resurrector_angel: {
        ...
        image: createImagePath("resurrector_angel"),
        color: "text-yellow-200",
        bgImageId: "role-bg-seer",
        team: "Aldeanos",
    },
    ...
    werewolf: {
        ...
        image: createImagePath("werewolf"),
    ...
    wolf_cub: {
        ...
        image: createImagePath("wolf_cub"),
        color: "text-red-400",
        bgImageId: "role-bg-werewolf",
        team: "Lobos",
    },
    ...
    seeker_fairy: {
        ...
        image: createImagePath("seeker_fairy"),
    ...
    shapeshifter: {
        ...
        image: createImagePath("shapeshifter"),
        color: "text-teal-300",
        bgImageId: "role-bg-villager",
        team: "Neutral",
    },
    drunk_man: {
        ...
        image: createImagePath("drunk_man"),
    ...
    cult_leader: {
        ...
        image: createImagePath("cult_leader"),
    ...
    fisherman: {
        ...
        image: createImagePath("fisherman"),
        color: "text-sky-600",
        bgImageId: "role-bg-villager",
        team: "Neutral",
    },
    ...
    executioner: {
        ...
        image: createImagePath("executioner"),
        color: "text-gray-400",
        bgImageId: "role-bg-hunter",
        team: "Neutral",
    },
    sleeping_fairy: {
        ...
        image: createImagePath("sleeping_fairy"),
