    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: '1.1rem', lineHeight: '1.6' }}>
          La página <strong>404 (No Encontrado)</strong> que está viendo es un síntoma de que este proyecto <strong>NO PUEDE COMPILARSE NI EJECUTARSE</strong> en este entorno de desarrollo en línea.
        </p>
