  ...
  return (
    <div className="space-y-5">
        ...
        <div>
          <div className="relative">
            ...
            <input
              ...
              {...form.register('email')}
              disabled={busy}
              className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-white placeholder:text-white/25 text-sm focus:outline-none focus:border-white/30 focus:bg-white/8 transition-all disabled:opacity-50"
            />
          </div>
        ...
        <div>
          <div className="relative">
            ...
            <input
              ...
              disabled={busy}
              className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-11 py-3 text-white placeholder:text-white/25 text-sm focus:outline-none focus:border-white/30 focus:bg-white/8 transition-all disabled:opacity-50"
            />
            <button
              type="button"
      ...
      <p className="text-center text-white/30 text-xs pt-1">
        ...
        <Link href="/register" className="text-white/60 hover:text-white underline underline-offset-2 transition-colors font-medium">
          Crear cuenta gratis
        </Link>
      </p>
    </div>
